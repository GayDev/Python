...
Решение на языке Python 3.
 Автор: А. Жуков, 2018
-------------------------------------------------
81) (А. Жуков) В вход программы поступают N <= 1000 натуральных чисел,
...
отличаются не менее, чем на 5. Напишите эффективную по времени и
...
2
В приведённом наборе из 7 чисел имеются две пары (4, 13) и (14, 13), сумма 
элементов которых нечётна, произведение кратно 13, и номера элементов 
в паре отличаются не менее, чем на 5.
"""
import sys
save_stdin = sys.stdin
sys.stdin = open("in/81.in")
